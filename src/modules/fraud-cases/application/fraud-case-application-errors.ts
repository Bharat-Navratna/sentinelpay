export const fraudCaseApplicationErrorCodes = [
  ...
  "FILE_EVIDENCE_LIMIT_REACHED", "EVIDENCE_NOT_AWAITING_UPLOAD",
  "EVIDENCE_VALIDATION_IN_PROGRESS", "EVIDENCE_VALIDATION_CONFLICT",
  "INVALID_FILE_EVIDENCE_METADATA", "FILE_EVIDENCE_PROCESSING_FAILED",
  "FILE_EVIDENCE_CLEANUP_NOT_ALLOWED",
...
const messages: Record<FraudCaseApplicationErrorCode, string> = {
  ...
  FILE_EVIDENCE_LIMIT_REACHED: "The file evidence item limit has been reached.",
  EVIDENCE_NOT_AWAITING_UPLOAD: "The evidence item is not awaiting an upload.",
  EVIDENCE_VALIDATION_IN_PROGRESS: "The evidence item is already being validated.",
  EVIDENCE_VALIDATION_CONFLICT: "The evidence validation could not be completed safely.",
  INVALID_FILE_EVIDENCE_METADATA: "The validated file evidence metadata is invalid.",
  FILE_EVIDENCE_PROCESSING_FAILED: "The evidence file could not be processed safely.",
  FILE_EVIDENCE_CLEANUP_NOT_ALLOWED: "The evidence file is not eligible for storage cleanup.",
